...
class NLP:
    ...
    def analysis(self, next_content):
        content = next_content
        print("Analyzing..."+content[URI])
        text_found = self.text_from_html(content[CONTENT])
        lang = self.get_language(text_found)
        text_cleaning = [
            self.clean_text(document, lang).split() for document in [text_found]]
